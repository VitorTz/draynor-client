...
interface LatestMangasPageProps {
  navigate: (page: PageType, data?: any) => void;
}

const LatestMangasPage = ({ navigate }: LatestMangasPageProps) => {
  ...
  const loadMangas = async () => {
    ...
    try {
      const res = await draynorApi.mangas.getLatest(limit, offset);
...
export default LatestMangasPage;
