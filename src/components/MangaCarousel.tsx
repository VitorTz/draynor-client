...
import type { PageType, Manga, MangaPageData } from '../types';
        ...
        <div className="manga-carousel-viewport" ref={viewportRef}>
          <div className="manga-carousel-slider" ref={sliderRef}>
            ...
            {mangas.map((pageData) => (
              ...
              >
                {/* O conteúdo do slide (fundo, overlay, info) permanece o mesmo */}
                <div
                ...
                <div className="slide-content">
                  <div className="slide-cover">
                    <img src={pageData.manga.cover_image_url} alt={pageData.manga.title} />
                  </div>
                  <div className="slide-info">
                    ...
                    <div className="slide-genres">
                      {pageData.genres.slice(0, 5).map(genre => (
                        <span key={genre.id} className="genre-tag">{genre.genre}</span>
                      ))}
                    </div>
                    <p className="slide-description">
                      {pageData.manga.descr ? truncateDescription(pageData.manga.descr) : 'Sem descrição disponível.'}
                    </p>
                    <button
